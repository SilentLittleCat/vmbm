            ...
            <div class="col-sm-12">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row sg-item">
                            <div class="col-sm-2 col-sm-offset-2 sg-label">out</div>
                            <div class="col-sm-6 sg-value">{{ $item->out }}</div>
                        </div>
                        <div class="row sg-item">
                        ...
                        <div class="row sg-item">
                            <div class="col-sm-2 col-sm-offset-2 sg-label">更新时间</div>
                            <div class="col-sm-6 sg-value">{{ $item->status_date_time }}</div>
                        </div>
                    </div>
                </div>
            </div>
