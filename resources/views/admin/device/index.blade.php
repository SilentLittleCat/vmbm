                            ...
                            @else
                                @foreach($list as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->IMEI }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-info" target="_blank" href="{{ '/admin/Device/qrcode?id=' . $item->id  }}">获取</a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="btn btn-sm btn-info btn-download" onclick="window.open('/admin/Device/download?id={{ $item->id }}', '_target')">二维码下载</div>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
